...
const PostCard = ({ post }) => {
  ...
  return (
   <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 mt-4'>
      ...
      <h1 className='transition duration-700 text-center mb-8 cursor-pointer text-color hover:text-red-300 text-3xl font-semibold'>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        ...
        <div className='font-medium text-gray-700'>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-darkPink" fill="none" viewBox="0 0 24 24" stroke="currentColor">
