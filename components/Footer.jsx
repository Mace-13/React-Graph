    ...
    <footer className="text-center relative inset-x-0 bottom-0 border-t border-stone-200">
      <div className="container pt-9">
        <div className="mb-9 flex justify-center">
          ...
          <a href="https://www.instagram.com/mandyptx/?hl=fr" className="mr-9 text-color hover:text-red-300">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href="https://www.linkedin.com/in/mandy-pletinckx-842422208/" className="mr-9 text-color hover:text-red-300">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          <a href="https://github.com/Mace-13" className="text-color hover:text-red-300">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
